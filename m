...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 582FBB654A
	for <lists@lfdr.de>; Wed, 18 Sep 2019 16:00:13 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id D0315DA5;
	Wed, 18 Sep 2019 13:59:56 +0000 (UTC)
X-Original-To: ksummit-discuss@lists.linuxfoundation.org
Delivered-To: ksummit-discuss@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 5873FD88
	for <ksummit-discuss@lists.linuxfoundation.org>;
	Wed, 18 Sep 2019 13:59:54 +0000 (UTC)
X-Greylist: from auto-whitelisted by SQLgrey-1.7.6
Received: from bombadil.infradead.org (bombadil.infradead.org
	[198.137.202.133])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 8B85C81A
	for <ksummit-discuss@lists.linuxfoundation.org>;
	Wed, 18 Sep 2019 13:59:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=HtqdMUqyUOFCY2ScQf4Lzm9l0uKQkeen1PDA5Nh7oFI=;
	b=QgpCwUsTdfcZqeu+jArIJiq9yr
...
Subject: [Ksummit-discuss] [PATCH v2] media: add a subsystem profile
	documentation
