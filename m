...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 494F75FFF2
	for <lists@lfdr.de>; Fri,  5 Jul 2019 06:10:46 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 3CC97CAE;
	Fri,  5 Jul 2019 04:10:35 +0000 (UTC)
X-Original-To: ksummit-discuss@lists.linuxfoundation.org
Delivered-To: ksummit-discuss@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id F102F723
	for <ksummit-discuss@lists.linuxfoundation.org>;
	Fri,  5 Jul 2019 04:10:32 +0000 (UTC)
X-Greylist: from auto-whitelisted by SQLgrey-1.7.6
Received: from ozlabs.org (bilbo.ozlabs.org [203.11.71.1])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id AB94E70D
	for <ksummit-discuss@lists.linuxfoundation.org>;
	Fri,  5 Jul 2019 04:10:31 +0000 (UTC)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits)
	server-digest SHA256) (No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 45g1bT2vqKz9sP7;
	Fri,  5 Jul 2019 14:10:29 +1000 (AEST)
From: Michael Ellerman <mpe@ellerman.id.au>
To: Thomas Gleixner <tglx@linutronix.de>,
	Geert Uytterhoeven <geert@linux-m68k.org>
In-Reply-To: <87wogx17a5.fsf@concordia.ellerman.id.au>
...
Date: Fri, 05 Jul 2019 14:10:29 +1000
Message-ID: <87r27515qi.fsf@concordia.ellerman.id.au>
MIME-Version: 1.0
